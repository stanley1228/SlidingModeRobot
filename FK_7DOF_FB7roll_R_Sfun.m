function [sys,x0,str,ts,simStateCompliance] = FK_7DOF_FB7roll_R_Sfun(t,x,u,flag)
...
function sys=mdlOutputs(t,x,u)
    ...
    ArmJoint_R_raw=reshape(ArmJoint_R,1,[]);% transfer to raw for drawing 10x3 => 1x30
    RotationM_R_raw=reshape(RotationM_R,1,[]);% transfer to raw for drawing 3x3=>1x9
    
sys = [PathIFKPoint_R,ArmJoint_R_raw,RotationM_R_raw];%now just consider x,y,z
