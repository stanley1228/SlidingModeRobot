...
FixedStep_as_str=get_param('PID_Dual_Robot_DC_model_no_vision_controller', 'FixedStep');
...
set_param('PID_Dual_Robot_DC_model_no_vision_controller', 'StopTime',StopTime_str)
